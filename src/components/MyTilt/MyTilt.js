...
class Tilt extends Component {
  constructor(props) {
    ...
    this.targetChild = this.settings.targetChild;
    this.childClassList = this.settings.childClassList ? this.settings.childClassList : '';
  ...
  render() {
    const childStyle = Object.assign({}, this.props.style, this.state.style);
    const style = this.targetChild ? {} : childStyle;
    const childClassList = this.childClassList;
    return (
      <div style={style}
        ...
        >
        { this.targetChild && 
            <div style={childStyle} className={childClassList}></div>
        }
        {this.props.children}
      </div>
    );
